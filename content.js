...
const i18n = {
  pt: {
    ...
    home: {
      ...
      rowProjetosDesc: "Uma seleção do que já construí em QA e sigo me aperfeiçoando, de plataformas a iniciativas autorais.",
    ...
    projetos: {
      intro:
        'Uma seleção do que já construí e validei, de plataformas de mobilidade e comércio exterior a sistemas de informação geológica, além de iniciativas autorais de QA e Produto.<p style="font-size: 12px;">Clique em <strong>Ver detalhes</strong> em cada card para abrir o escopo completo.</p>',
      card0Date: "jun 2026 - atual", // usado só pelo card do Media Cloud em #productOwner
    ...
    productOwner: {
      ...
      cardDesc: 'Responsável pela evolução e melhoria contínua do <strong>Media Cloud</strong>, projeto core da Impulso dentro do ecossistema <strong>Salesforce</strong>, cobrindo a operação de mídia como um todo, do planejamento à entrega e faturamento das campanhas. Ainda em curva de aprendizado ativa, apoiando os times enquanto evoluo o processo no dia a dia.',
      cardDetails:
  ...
  en: {
    ...
    home: {
      ...
      rowProjetosDesc: "A selection of what I've built in QA and keep refining, from platforms to self-authored initiatives.",
    ...
    projetos: {
      intro:
        'A selection of what I\'ve built and validated, from mobility and foreign trade platforms to geological information systems, plus self-authored initiatives in QA and Product.<p style="font-size: 12px;">Click <strong>View details</strong> on each card to open the full scope.</p>',
      card0Date: "Jun 2026 - present", // used only by the Media Cloud card in #productOwner
